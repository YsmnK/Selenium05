...
public class CheckBoxDemo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// One-line, method chaining for female label
		...
		// findElements will return a List of WebElement
		// Nine WebElements are located with the following xpath

		List<WebElement> elements = driver
				.findElements(By.xpath("//table[@class='inline_grid choices']/tbody/tr/td/label"));

		// I want to clcik on Female and Saturday and Sunday
